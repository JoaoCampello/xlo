...
<?php
$c = $_REQUEST['cod'];
$sql = "SELECT * FROM Produtos WHERE CodProduto = $c";
$res = $lig->query($sql);
$lin = $res->fetch_array();
...
if (mysqli_num_rows($res) == 0) {
  die("
		<br><br><br><br>
		<div class='section-title'>
			<p align='center'>Este produto não existe!</p>
			<div class='text-center mt-4 mb-5'> <button class='btn btn-success send px-3' onclick='history.go(-1);'><i class='fa fa-long-arrow-left mr-1'></i> Voltar</button> </div>
		</div>
			");
}
...
<div class="container">
  ...
  <div class="section-title" align="center">
    <p>Alteração do anúncio</p>
    <p><?php echo $lin['Titulo']; ?></p>
  </div>
  ...
  <div class="row">
    ...
    <div class="col-lg-8 col-lg-offset-2">
      ...
      <form enctype="multipart/form-data" id="contact-form" method="POST" role="form" autocomplete="off" action="index.php?cmd=alt2-prod&cod=<?php echo $c; ?>">

        <div class="messages"></div>

        <div class="controls">

          <input type="hidden" name="CodProduto" value=<?php echo $c; ?>>
          <input type="hidden" name="CodUti" value=<?php echo $_SESSION['CodUti']; ?>>

          <div class="col-md-12">
            <div class="form-group">
              <label for="Titulo">Título *</label>
              <input id="Titulo" type="text" name="Titulo" class="form-control" placeholder="ex. iPhone 11 com garantia" required="required" data-error="É necessário um título!" value="<?php echo $lin['Titulo']; ?>">
          ...
          <div class="col-md-12">
            <div class="form-group">
              ...
              <select class="form-control" name="CodCat" required="required">

                <?php
                $sql1 = "select * from Categoria";
                $res1 = $lig->query($sql1);
                while ($lin1 = $res1->fetch_array()) {
                  if ($lin['CodCat'] == $lin1['CodCat'])
                    echo "<option value=", $lin1['CodCat'], " selected>", $lin1['CatDgs'], "</option>";
                  else
                    echo "<option value=", $lin1['CodCat'], ">", $lin1['CatDgs'], "</option>";
                }
                echo "</select>";
                ?>
          ...
          <div class="col-md-6" style="margin-right: 400px;">
            <div class="form-group">
              ...
              <input id="Preco" type="number" step="0.01" name="Preco" class="form-control" placeholder="0" required="required" value="<?php echo $lin['Preco']; ?>" autofocus="autofocus" />
          ...
          <div class="row" id="imgs">
            <div class="form-group">
              ...
              $fotos = "SELECT FotoImg FROM Fotos WHERE CodProduto=$c";
              $res2 = $lig->query($fotos);
              $nrows = mysqli_num_rows($res2);
              ...
              for ($i = 1; $i <= $nrows; $i++) {
                ...
                <label for="0' . $i . '">
                  <div class="upload-wrap">
                    <div class="uploadpreview 0' . $i . '">';
                while ($lin2 = $res2->fetch_array()) {
                  echo '<img id="img0' . $i . '" src="./imgs/' . $lin2['FotoImg'] . '" width="145" height="145">';
                  break;
                }
                echo '
                  </div>
                    <input type="hidden" name="MAX_FILE_SIZE" value="300000000" />
                    <input id="0' . $i . '" type="file" name="Foto' . $i . '" accept="image/*">
                  </div>
                </label>
              ...
              for ($i = $nrows + 1; $i <= 6; $i++) {
                ...
                <label for="0' . $i . '">
                  ...
                  <img id="img0' . $i . '"src="./imgs/no_image.png" width="145" height="145">
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <div class="autocomplete">
              <input type="text" name="Localizacao" placeholder="Localização do anúncio..." required="required" value="<?php echo $lin['Localizacao']; ?>">
        ...
        <div class="col-md-12">
          <div class="form-group">
            ...
            <textarea style="resize: none" id="Descricao" maxlength="800" minlength="30" name="Descricao" class="form-control" placeholder="Escreve o que gostarias de ler se fosses tu a ver este anúncio" rows="12" required="required" data-error="Please,leave us a message."><?php echo $lin['Descricao']; ?></textarea>
            <div class="help-block with-errors"></div>
          </div>
        </div>
        <div class="col-md-12">
          <input type="submit" class="btn btn-success btn-send" value="Alterar Anúncio">
        </div>
        <br>
    </div>
    </form>
